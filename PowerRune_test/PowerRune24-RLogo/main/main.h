...
// Startup test switches (0: disable, 1: enable)
#ifndef ENABLE_ALL_ARMOUR_ON_20S_TEST
#define ENABLE_ALL_ARMOUR_ON_20S_TEST 0
#endif

#ifndef ENABLE_FORCE_LIGHT_SEQ_TEST
#define ENABLE_FORCE_LIGHT_SEQ_TEST 0
#endif

// Hit flash compensation on master:
// 1 = send a short STOP->START pulse to the hit armour for visible blink effect.
#ifndef ENABLE_HIT_FLASH_EFFECT
#define ENABLE_HIT_FLASH_EFFECT 1
#endif
